...
// ⛔️ එකතු කරන ලදි: useNavigate hook එක import කරන්න
...
export default function Dashboard({ user }) { // App.js වෙතින් user prop එක ලබා ගන්න
  ...
  // ⛔️ එකතු කරන ලදි: useNavigate hook එක initialize කරන්න
  ...
  // ⛔️ එකතු කරන ලදි: All Requests Page වෙත navigate කිරීමට ශ්‍රිතය
  const handleViewAllRequests = () => {
    navigate('/requests'); // /requests path එකට යොමු කරන්න
  };
    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="w-64 bg-gray-200 dark:bg-gray-700 shadow-lg flex flex-col justify-between p-4">
        ...
        <div className="mt-4 space-y-2">
          {/* ⛔️ එකතු කරන ලදි: All Requests බොත්තම */}
          <button
